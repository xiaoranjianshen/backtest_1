# run_scripts/run_amplitude_rank_donchian.py
# -*- coding: utf-8 -*-
...
def build_selector(top_n: int, weight_method: str, max_per_sector: int):
    ...
    selection_path = output_dir / f"amplitude_rank_donchian_top{top_n}_{weight_method}_{sector_tag}_selection.csv"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run dynamic amplitude-rank Donchian/ATR strategy.")
    ...
    analyzer = run_backtest(
        strategy_class=AmplitudeRankDonchianStrategy,
